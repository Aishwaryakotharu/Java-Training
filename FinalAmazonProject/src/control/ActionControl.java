...
public class ActionControl extends HttpServlet {
	private static final long serialVersionUID = 1L;
		...
		public void init(ServletConfig config) throws ServletException {
			...
			DBUtility.setDriver(dbConfigFile.getProperty("driver"));
			DBUtility.setUrl(dbConfigFile.getProperty("url"));
			DBUtility.setUsername(dbConfigFile.getProperty("username"));
			DBUtility.setPassword(dbConfigFile.getProperty("password"));
		}
